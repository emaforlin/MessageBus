...
const (
	MessageBusService_Publish_FullMethodName   = "/messagebus.MessageBusService/Publish"
	MessageBusService_Subscribe_FullMethodName = "/messagebus.MessageBusService/Subscribe"
)
...
func (c *messageBusServiceClient) Subscribe(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Message], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type MessageBusService_SubscribeClient = grpc.ServerStreamingClient[Message]

// MessageBusServiceServer is the server API for MessageBusService service.
// All implementations must embed UnimplementedMessageBusServiceServer
...
// UnimplementedMessageBusServiceServer must be embedded to have
...
func (UnimplementedMessageBusServiceServer) Subscribe(*SubscribeRequest, grpc.ServerStreamingServer[Message]) error {
	return status.Errorf(codes.Unimplemented, "method Subscribe not implemented")
}
func (UnimplementedMessageBusServiceServer) mustEmbedUnimplementedMessageBusServiceServer() {}
...
func _MessageBusService_Subscribe_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(MessageBusServiceServer).Subscribe(m, &grpc.GenericServerStream[SubscribeRequest, Message]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type MessageBusService_SubscribeServer = grpc.ServerStreamingServer[Message]
...
var MessageBusService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "messagebus.MessageBusService",
	...
	Metadata: "proto/messagebus.proto",
}
